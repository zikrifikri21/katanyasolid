...
const GooeyNav: React.FC<GooeyNavProps> = ({ items, animationTime = 600, particleCount = 15, particleDistances = [90, 10], particleR = 100, timeVariance = 300, colors = [1, 2, 3, 1, 2, 3, 1, 4], initialActiveIndex = 0 }) => {
      ...
      <style>
        {`
          ...
          .effect.filter::before {
            ...
            inset: -75px;
            z-index: -2;
            background: black linear(0, 0, 0, 0.1) 0% 0% / 100% 100% no-repeat;
          }
          .effect.filter::after {
            content: "";
            position: absolute;
